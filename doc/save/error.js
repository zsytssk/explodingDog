b(function() {
            ...
            if (data.promptMsg) {
                setTimeout(function() {
                    Sail.director.popScene(
                        new Alert.propMsg(data.promptMsg.content),
                    );
                }, 2000);
            }
        });
    ...
    _proto.dispathError = function(code, cmd, msg, data) {
        ...
        switch (code.toString()) {
            ...
            case '110': //房间维护
                Sail.director.popScene(
                    new Alert.Message(msg, function() {
            ...
            case '1002':
                Sail.io.socket.end();
                Sail.director.popScene(
                    new Alert.Message('异地登录，请刷新', function() {
                        // location.reload();
                        Sail.Utils.set_param('t', new Date().getTime());
                    }),
                );
            ...
            case '114':
                ...
                Sail.director.popScene(
                    new Alert.Message(
                        '您积分或欢乐值超过当日最大使用额度，若要继续游戏，请充值欢乐豆',
                    ),
                );
                break;
            ...
            case '115':
                ...
                Sail.director.popScene(
                    new Alert.Message(
                        '很抱歉！经系统检测，您的账号存在异常，无法进行该游戏。如有疑问，请联系客服：4001081768',
                    ),
                );
                break;
            case '116':
            ...
            case 'xhrError':
                ...
                Sail.director.popScene(
                    new Alert.Message('网络异常，请检查您的网络!'),
                );
                break;
            case '200':
