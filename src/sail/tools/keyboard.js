;(function () {
    ...
    var KeyBoardPanel = (function (_super) {
        ...
        _proto.enter = function (value) {
            ...
            Laya.Tween.to(this, {bottom : 0}, 200, Laya.Ease.cubicOut);
        }
        _proto.exit = function (type) {
            ...
            Laya.Tween.to(this, {bottom : -this.height}, 150, Laya.Ease.cubicOut, Laya.Handler.create(this, function (type) {
    ...
    (function (_super) {
        ...
        _proto.onExit = function (type) {
            this.removeSelf();
            this.config.close && this.config.close.call(this.config.caller, type, type === "confirm" ? this.textValue + "" : null);
            this.textValue = "";
        }
        _proto.onInput = function (text) {
            switch(text){
                case "删除":
                    ...
                    this.config.input && this.config.input.call(this.config.caller, this.textValue);
                    break;
                case "确定":
