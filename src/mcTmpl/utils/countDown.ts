...
export class CountDown {
  // 倒计时结束执行函数
  end_func_list: Function[] = [];
  // 每次计数都会执行函数
  count_func_list: Function[] = [];
  info = {} as t_count_info;
  interval: FrameInterval = new FrameInterval();
  constructor() {
  }
  init() {
  }
   ...
   * @param fun 绑定函数
   */
  public onCount(fun: Function): CountDown {
